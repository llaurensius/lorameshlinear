...
#define EEPROM_SIZE 1 // Ukuran EEPROM untuk menyimpan nodeId

uint8_t nodeId = 1; // Set this to 1, 2, 3, 4, or 5 for each node
...
void setup() {
  ...
  // Simpan nodeId ke EEPROM
  EEPROM.write(0, nodeId);
  EEPROM.commit(); // Simpan perubahan ke EEPROM

  // Baca nodeId dari EEPROM
